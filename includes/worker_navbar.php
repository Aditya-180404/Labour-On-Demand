...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary sticky-top shadow-sm border-bottom border-white border-opacity-10">
    <div class="container">
        <a class="navbar-brand fw-bold d-flex align-items-center" href="<?php echo $path_prefix; ?>/worker/dashboard.php">
        ...
        <div class="collapse navbar-collapse" id="workerNav">
            <ul class="navbar-nav ms-auto align-items-center text-center">
                <!-- Overview -->
                <li class="nav-item">
                    <a class="nav-link <?php echo ($current_page == 'dashboard.php') ? 'active' : ''; ?>" href="<?php echo $path_prefix; ?>/worker/dashboard.php">
                ...
                <!-- My Jobs -->
                <li class="nav-item">
                    <a class="nav-link <?php echo ($current_page == 'my_jobs.php') ? 'active' : ''; ?>" href="<?php echo $path_prefix; ?>/worker/my_jobs.php">
                ...
                <!-- Profile -->
                <li class="nav-item">
                    <a class="nav-link <?php echo ($current_page == 'edit_profile.php') ? 'active' : ''; ?>" href="<?php echo $path_prefix; ?>/worker/edit_profile.php">
                ...
                <!-- Reviews -->
                <li class="nav-item">
                    <a class="nav-link <?php echo ($current_page == 'reviews.php') ? 'active' : ''; ?>" href="<?php echo $path_prefix; ?>/worker/reviews.php">
                ...
                <li class="nav-item dropdown ms-lg-2">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-4 mt-2">
                        ...
                        <li><a class="dropdown-item py-2" href="<?php echo $path_prefix; ?>/worker/dashboard.php"><i class="fas fa-tachometer-alt me-2 text-primary"></i>Command Center</a></li>
                        <li><a class="dropdown-item py-2" href="<?php echo $path_prefix; ?>/worker/my_jobs.php"><i class="fas fa-briefcase me-2 text-success"></i>My Bookings</a></li>
                        <li><a class="dropdown-item py-2" href="<?php echo $path_prefix; ?>/worker/reviews.php"><i class="fas fa-star me-2 text-warning"></i>My Reviews</a></li>
                        <li><a class="dropdown-item py-2" href="<?php echo $path_prefix; ?>/worker/edit_profile.php"><i class="fas fa-id-card me-2 text-info"></i>Manage Profile</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item py-2 text-danger" href="<?php echo $path_prefix; ?>/logout.php"><i class="fas fa-power-off me-2"></i>Logout</a></li>
                    </ul>
                </li>
